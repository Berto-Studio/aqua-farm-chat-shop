...
const services = [
  {
    ...
    description: "Professional guidance for setting up and optimizing your fish farm operations",
    icon: Users,
    features: [
  ...
  },
  {
    ...
    description: "Complete hatchery setup and management services for sustainable fish production",
    icon: Settings,
    features: [
  ...
  },
  {
    ...
    description: "Hands-on training programs to master catfish fingerling production techniques",
    icon: GraduationCap,
    features: [
...
export default function Services() {
  ...
  const onSubmit = (data: ServiceRequestForm) => {
    ...
    toast({
      ...
      description: "We'll get back to you within 24 hours to discuss your needs.",
    });
    form.reset();
  };
      ...
      <section className="bg-primary text-white py-16">
        <div className="container text-center">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto">
            From farm consultation to hatchery operations and specialized training, 
            we provide comprehensive services to help you succeed in fish farming.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 container">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Choose from our range of professional services designed to support every aspect of your fish farming journey.
          </p>
        </div>
      ...
      <section className="py-16 bg-secondary">
        <div className="container max-w-2xl">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Request a Service</h2>
            <p className="text-muted-foreground">
              Tell us about your needs and we'll create a customized solution for your fish farming goals.
            </p>
          </div>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent>
                              <SelectItem value="consultation">Farm Consultation</SelectItem>
                              <SelectItem value="hatchery">Hatchery Operations</SelectItem>
                              <SelectItem value="training">Catfish Fingerling Training</SelectItem>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card>
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-muted-foreground">
                Over 15 years of experience in aquaculture with hundreds of successful farm setups.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-muted-foreground">
                We don't just set you up and leave. Continuous support ensures your long-term success.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-muted-foreground">
                Our training programs are certified and recognized by aquaculture industry standards.
              </p>
            </CardContent>
          </Card>
        </div>
