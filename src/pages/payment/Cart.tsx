...
const sampleCartItems = [
  {
    ...
    price: 25.99,
    image:
      "https://images.unsplash.com/photo-1545529468-42764ef8c85f?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    quantity: 2,
    totalPrice: 51.98,
  },
  {
    ...
    price: 69.99,
    image:
      "https://images.unsplash.com/photo-1584689769272-c5a27caefbe7?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    quantity: 1,
    totalPrice: 69.99,
  },
];
                      ...
                      <div className="p-4 flex-grow flex flex-col justify-between">
                        ...
                        <div className="flex justify-between items-end mt-4">
                          <div className="flex items-center">
                            ...
                            <span className="mx-3 min-w-10 text-center">
                              {item.quantity}
                            </span>
                            <Button
                              variant="outline"
